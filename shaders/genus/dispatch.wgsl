...
fn evalGenusDensity(genusIndex : i32, compatibilityDensity : f32) -> f32 {
  switch genusIndex {
    ...
    case GENUS_CUMULONIMBUS: { return evalCumulonimbus(compatibilityDensity); }
    ...
    case GENUS_CIRRUS: { return evalCirrus(compatibilityDensity); }
