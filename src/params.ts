...
export const CLOUD_PRESETS: Record<string, ShapePreset> = {
  ...
  cumulonimbus:  { density: 2.2, coverage: 0.5,  altitude: 0.7,  scale: 5.0,  detail: 2.0, cloudHeight: 3.5, coverageThreshold: 0.1,  edgeSharpness: 0.8,  worleyBlend: 0.65, detailStrength: 1.1, altBase: 0.0,  altTop: 1.0,  absorptionCoeff: 0.1,   phaseForward: 0.7,  phaseBack: -0.3, silverLining: 0.6,  baseDarkening: 0.6,  sssStrength: 0.2,  sunDiscVisible: 0.0, haloEffect: 0.0, internalLightning: 0.0, morphology: { baseRoundness: 0.5,  anvilStrength: 0.85, topCutoffSharpness: 0.85, cirrusFiberStrength: 0.0, cirrusFiberCurl: 0.0, convectiveTowerStrength: 0.82, convectiveCellScale: 0.55, tileScale: 0.0 }, edgeStyle: { edgeHardness: 0.85, edgeErosionStrength: 0.85 } },
...
export function createDefaultParams(): CloudParams {
  return {
    ...
    cacheUpdateRate: 2,
    cacheSmooth: 0,
    densityProducerMode: 1,
    densityStorageMode: 0,
    sunAzimuth: 34,
    sunElevation: 70,
    silverIntensity: 0,
